...
CSRF_TRUSTED_ORIGINS = ['https://vittzios.com']
...
WSGI_APPLICATION = 'Vittzios_v2.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'Web.wholesomenutritech@gmail.com'
EMAIL_HOST_PASSWORD = 'mhxq qqjd wrgx maah'
